"""
Constantes utilizadas em todo o projeto RacoGraph.
Centraliza valores de configuração e convenções.
"""
...
# Personalized PageRank (para recomendações de usuário)
DEFAULT_RESTART_PROB_USER = 0.15

# Para busca de filmes similares (maior foco na vizinhança)
